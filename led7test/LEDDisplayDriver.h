...
// This is version 1.16 from 2020-1-2
...
const DIGIT_TYPE digitN = SEG_C | SEG_E | SEG_F | SEG_B | SEG_A;
...
const DIGIT_TYPE digitV = digitU;
...
const DIGIT_TYPE digiti = SEG_E;
const DIGIT_TYPE digitj = SEG_B | SEG_C | SEG_D;
const DIGIT_TYPE digitk = digitK;
const DIGIT_TYPE digitl = SEG_F | SEG_E;
const DIGIT_TYPE digitm = digitM;
const DIGIT_TYPE digitn = SEG_E | SEG_C | SEG_G;
...
const DIGIT_TYPE digitCloseParen = SEG_A | SEG_B | SEG_C | SEG_D;
const DIGIT_TYPE digitBackTick = digitQuote1;
const DIGIT_TYPE digitOpenBrace = digitOpenParen;
const DIGIT_TYPE digitCloseBrace = digitCloseParen;
const DIGIT_TYPE digitAt = digitEmpty;
const DIGIT_TYPE digitQuestion = SEG_A | SEG_B | SEG_G | SEG_E;
const DIGIT_TYPE digitSemiColon = digitEmpty;
const DIGIT_TYPE digitColon = SEG_A | SEG_D;
const DIGIT_TYPE digitComma = SEG_E;
...
const DIGIT_TYPE digitBackTick = SEG_K;
const DIGIT_TYPE digitDollar = SEG_A | SEG_F | SEG_G | SEG_H | SEG_C | SEG_D | SEG_L | SEG_O;
const DIGIT_TYPE digitPercent = SEG_F | SEG_N | SEG_M | SEG_C;
const DIGIT_TYPE digitOpen = SEG_A | SEG_D | SEG_E | SEG_F;  // Opening bracket [
const DIGIT_TYPE digitClose = SEG_A | SEG_B | SEG_C | SEG_D;  // Closing bracket ]
const DIGIT_TYPE digitOpenParen = SEG_M | SEG_P;
const DIGIT_TYPE digitCloseParen = SEG_K | SEG_N;
const DIGIT_TYPE digitOpenBrace = SEG_A | SEG_D | SEG_K | SEG_G | SEG_N; // open brace {
const DIGIT_TYPE digitCloseBrace = SEG_A | SEG_M | SEG_H | SEG_P | SEG_D; // close brace }
const DIGIT_TYPE digitAsterix = SEG_G | SEG_H | SEG_M | SEG_K | SEG_N | SEG_P;
const DIGIT_TYPE digitPlus = SEG_G | SEG_H | SEG_L | SEG_O;
const DIGIT_TYPE digitDp = SEG_DP;              // Decimal point
const DIGIT_TYPE digitColon = SEG_D | SEG_A;
const DIGIT_TYPE digitSemiColon = SEG_A | SEG_N;
const DIGIT_TYPE digitComma = SEG_N;
...
const DIGIT_TYPE digitQuestion = SEG_A | SEG_B | SEG_H | SEG_O;
const DIGIT_TYPE digitUnderscore = SEG_D;
const DIGIT_TYPE digitVerticalslash = SEG_L | SEG_O;
const DIGIT_TYPE digitAt = SEG_L | SEG_G | SEG_F | SEG_A | SEG_B | SEG_C | SEG_D;
const DIGIT_TYPE digitAmpersand = SEG_A | SEG_K | SEG_M | SEG_G | SEG_E | SEG_D | SEG_P;
