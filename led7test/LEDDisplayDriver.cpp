...
const PROGMEM DIGIT_TYPE letterPatterns[] = {
  // Symbols
  digitSpace, digitExclamation, digitQuote2, digitEmpty, digitDollar, digitPercent, digitAmpersand, digitQuote1,
  digitOpenParen, digitCloseParen, digitAsterix, digitPlus, digitComma, digitMinus, digitDp, digitSlash,
  // Numbers
  digit0, digit1, digit2, digit3, digit4, digit5, digit6, digit7,
  digit8, digit9, digitColon, digitSemiColon, digitLT, digitEqual, digitGT, digitQuestion,
  // Upper case alphabet
  digitAt, digitA, digitB, digitC, digitD, digitE, digitF, digitG,
  ...
  // Lower case alphabet
  digitBackTick, digita, digitb, digitc, digitd, digite, digitf, digitg,
  digith, digiti, digitj, digitk, digitl, digitm, digitn, digito,
  digitp, digitq, digitr, digits, digitt, digitu, digitv, digitw,
  digitx, digity, digitz, digitOpenBrace, digitVerticalslash, digitCloseBrace, digitEmpty, digitEmpty
};
...
void LEDDisplayDriver::showTextScroll(const String msg, byte first, byte count) {
  for (byte i = 0; i <= msg.length() - count; i++) {
