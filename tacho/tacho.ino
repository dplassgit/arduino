/**
   Tachometer using a hall-effect sensor, writing output to VFD display.
...
void Pulse_Event() {
  // The interrupt runs this to calculate the period between pulses:
